            ...
            <Row gutter={[16, 16]} style={{ alignItems: 'stretch' }}>
                  ...
                  <div style={{ marginBottom: 8 }}>
                    <Space direction="vertical" size={4} style={{ width: '100%' }}>
                      <div style={{ fontSize: '12px', color: '#666' }}>
                        标准扣分: <strong>0.5分/次</strong>
                      </div>
                    </Space>
                  </div>
                  <div style={{ fontSize: '11px', color: '#999', lineHeight: '1.3' }}>
                    无故未参加上级或本级召开的各类会议，包括政治教育的 educations、业务培训、政策法规和的政治委员会建设学习，以及支部“三会一课”活动、青年理论小组学习等，每例扣 0.5 分。
                  </div>
                </Card>
              </Col>
              ...
              <Col xs={24} sm={12} md={8} style={{ display: 'flex' }}>
                 ...
                 >
                  ...
                  <div style={{ fontSize: '11px', color: '#999', lineHeight: '1.3' }}>
                    未按要求完成学习任务、做好学习笔记、上交心得体会文章的，每例扣 0.5 分。
                  </div>
                </Card>
              </Col>
